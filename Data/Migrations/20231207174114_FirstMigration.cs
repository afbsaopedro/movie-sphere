    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserMovie", x => new { x.FavouriteMoviesId, x.UsersWhoFavouritedId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserMovie_AspNetUsers_UsersWhoFavouritedId",
                        column: x => x.UsersWhoFavouritedId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserMovie_Movies_FavouriteMoviesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserMovie1", x => new { x.UsersInWatchlistId, x.WatchlistId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserMovie1_AspNetUsers_UsersInWatchlistId",
                        column: x => x.UsersInWatchlistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserMovie1_Movies_WatchlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserMovie_UsersWhoFavouritedId",
                table: "ApplicationUserMovie",
                column: "UsersWhoFavouritedId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserMovie1_WatchlistId",
                table: "ApplicationUserMovie1",
                column: "WatchlistId");
