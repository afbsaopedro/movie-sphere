    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>().HasData(
                new Movie { Id = 1, Title = "Oppenheimer", ReleaseYear = 2023, Description = "The world forever changes. The story of J. Robert Oppenheimer's role in the development of the atomic bomb during World War II." },
                new Movie { Id = 2, Title = "Barbie", ReleaseYear = 2023, Description = "She's everything. He's just Ken. Barbie and Ken are having the time of their lives in the colorful and seemingly perfect world of Barbie Land. However, when they get a chance to go to the real world, they soon discover the joys and perils of living among humans." },
